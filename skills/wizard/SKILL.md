...
> Adapted from [mattpocock/skills](https://github.com/mattpocock/skills) (MIT). House notes: wizards are for FOUNDER-GATED steps only (account signups, console dashboards, pairing codes — the steps agents literally cannot do). If the agent can do it with credentials already in `.env`, it does it itself instead.
